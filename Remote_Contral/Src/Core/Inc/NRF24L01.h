...
#define NRF_CSN_Pin GPIO_PIN_15      // PA4 - 片选引脚，推挽输出模式（初始化为高电平）
#define NRF_CE_Pin GPIO_PIN_12       // PB1 - 使能引脚，推挽输出模式（初始化为低电平）
#define NRF_IRQ_Pin GPIO_PIN_6      // PB0 - 中断引脚，外部中断模式（下降沿触发）
...
/* Note:Put this callback function into the main.c file */
// void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
// {
//   switch (GPIO_Pin) {
//     case NRF_IRQ_Pin:
//         /* TxFIFO blocking check */
